...
function generateImages(imageUrl, selectedValues, isImg2Img) {
  ...
  const selectedPicture = pictureSelect.value;
    const promptInit = `(interior design:1), [3-D-model: hyper-realistic:1], (8k high resolution:1), (enhance:1), [cinematic-diva: perfect-morphology:1], [hyper-detailed-small-details: perfect-details:1], (((symmetry))),  model lora:SDXLrender_v2.0:1,`;
